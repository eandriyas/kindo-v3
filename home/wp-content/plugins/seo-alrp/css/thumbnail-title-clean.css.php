...
<style type="text/css">
/**
* thumbnail-title-clean related posts style  
**/
#alrp-related-posts h3, #alrp-related-posts h2{font-size:1.2em;font-style:normal;margin-bottom: 10px;}
.alrp-content-caption{background:none repeat scroll 0 0 #FFF;border:1px solid rgba(255,255,255,0.5);box-shadow:1px 1px 3px rgba(255,255,255,0.5);float:left;line-height:18px;margin:0 2px 10px 0;max-width:<?php echo ($options['imgw']+10); ?>px;padding:5px;text-align:center;width:<?php echo ($options['imgw']+10); ?>px; <?php echo $height; ?>}
.alrp-content-caption:hover{border:1px solid rgba(255,255,255,0.5);box-shadow:1px 1px 3px rgba(0,0,0,0.5);}
