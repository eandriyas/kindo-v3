							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $v['poster'] ?></td>
										<td><?php echo $v['status'] ?></td>
										<td>
											<a title="accept" class="btn btn-default" href="<?php echo site_url('super/super/btn_proc2?stat=1&id='.$v['id_req'])?>"><span class="glyphicon glyphicon-ok-circle"></span></a>
											<a title="reject" class="btn btn-default" href="<?php echo site_url('super/super/btn_proc2?stat=0&id='.$v['id_req'])?>"><span class="glyphicon glyphicon-remove-circle"></span></a>
										</td>
									</tr>
									<?php  $n++; } ?>
								</tbody>
