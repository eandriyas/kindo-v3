								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<?php foreach ($view as $v) {
											...
											$judul = str_replace(' ', '_', $v['judul_kompetisi']);
											?>
											<tr> 
												<td><?php echo $n;?></td>
												...
												<td>
													<div class="btn-group">
														<a href="<?php echo site_url().'/super/super/edit'.'/?id='.$id; ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
														<a href="<?php echo site_url().'/kompetisi/detail/'.$id.'/'.$judul; ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-right"></span></a>
														<a onclick="return confirm('Anda Yakin!')" href="<?php echo site_url('super/super/delete_kompetisi?id='.$v['id_kompetisi'])?>" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span></a>
													</div>
												</td>
											</tr>
											<?php $n++;
