							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
											<a title="accept" class="btn btn-default" href="<?php echo site_url('super/super/btn_accept_kompetisi?id='.$v['id_kompetisi'])?>"><span class="glyphicon glyphicon-ok-circle"></span></a>
											<a title="reject" class="btn btn-default" href="<?php echo site_url('super/super/btn_reject_kompetisi?id='.$v['id_kompetisi'])?>"><span class="glyphicon glyphicon-remove-circle"></span></a>
