...
<div class="row-fluid">
	...
	<div class="col-md-10">
		...
		<div class="panel panel-default">
			<div class="panel-heading">Modera</div>
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
										<a title="banned" class="btn btn-default" href="<?php echo site_url('super/super/btn_user?act=0&id='.$v['id_user'])?>"><span class="glyphicon glyphicon-minus-sign"></span></a>
										<a title="active" class="btn btn-default" href="<?php echo site_url('super/super/btn_user?act=1&id='.$v['id_user'])?>"><span class="glyphicon glyphicon-ok-sign"></span></a>
										</td>										
									</tr>
									<?php  $n++; } ?>
								</tbody>
