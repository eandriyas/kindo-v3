								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											?>
											<a class="btn btn-default" title="edit" href="<?php echo site_url('super/super/edit_post?id='.$v['id'])?>"><span class="glyphicon glyphicon-pencil"></span></a> 
											<a class="btn btn-default" title="delete" href="<?php echo site_url('super/super/delete_post?id='.$v['id'])?>"><span class="glyphicon glyphicon-trash"></span></a>
											<a target="_blank" class="btn btn-default" title="view" href="<?php echo site_url('publik/read/'.$id.'/'.$judul)?>"><span class="glyphicon glyphicon-chevron-right"></span></a>
										</td>
									</tr>
									<?php $n++; } ?>
								</tbody>
