	...
	<div class="row">
		...
		<div class="col-md-10">
			...
			<tbody>
					...
					<td>
					<a title="lihat detail" target="_blank" href="<?php echo site_url().'/kompetisi/detail/'.$id.'/'.$judul?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-right"></span></a>
					<a title="batal tandai" target="_blank" href="#" class="btn btn-default"><span class="glyphicon glyphicon-remove-circle"></span></a>
					</td>
					</tr>
					<?php
					$n++;
