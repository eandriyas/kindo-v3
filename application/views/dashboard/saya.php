			...
			<table class="table table-hover">
			  ...
			  <tbody>
			  	...
			  	<tr> 
				  	...
				  	<td><a href="<?php echo site_url().'/dashboard/edit'.'?id='.$id; ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span>
				  	<a target="_blank" href="<?php echo site_url().'/kompetisi/detail/'.$id.'/'.$judul; ?>" class="btn btn-default"><span class="glyphicon glyphicon-chevron-right"></span></td>
			  	</tr>
			  	<?php $n++;
			  	} ?>
			  </tbody>
