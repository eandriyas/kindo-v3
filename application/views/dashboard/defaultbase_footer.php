...
<footer>
      ...
      <div class="row">
        ...
        <div class="footer-link col-md-2">          
          <ul class="menu">
            ...
            <li><a target="_blank" href="https://plus.google.com/u/0/+Kompetisiindonesia">Google+</a></li>
            <li><a target="_blank" href="http://facebook.com/kompetisiindo">Facebook</a></li>
            <li><a target="_blank" href="http://twitter.com/kompetisiindo">Twitter</a></li>
            <li><a href="#">RSS</a></li>           
          </ul>
        </div>
        <div class="footer-link col-md-2">
          <ul class="menu">
            <li><strong>Ada Pertanyaan</strong></li>
            <li><a href="#">Email : sc@kompetisiindonesia.com</a></li>
          </ul>
        </div>
  ...
  <section class="footer-link partner"> 
    ...
    <div class="container">
      <div class="row">
        <center>
         <img src="<?php echo base_url('images/partner/indigo.gif')?>"/>
         <img src="<?php echo base_url('images/partner/eventbrite.png')?>"/>
       </center>
     </div>
   </div>
 </section>
