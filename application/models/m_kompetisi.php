...
class m_kompetisi extends CI_Model{
	...
	function get_competition_by_id_kompetisi($id){
		$sql = "SELECT id_kompetisi, kompetisi.id_main_kat AS 'id_main_kat', kompetisi.id_sub_kat AS 'id_sub_kat', judul_kompetisi, poster,penyelenggara, konten, tgl_buat, tgl_edit, user.username AS 'author', main_kat.main_kat AS 'kategori', sort, hadiah, pengumuman, deadline, total_hadiah, sumber, rating
	...
	function show_kompetisi_dipasang($id, $limit, $offset) {
		$sql = "SELECT user.username AS 'authusername', kompetisi.poster AS 'poster',kompetisi.id_kompetisi AS 'id',thumb.thumb AS 'thumb',kompetisi.sort AS 'sort', kompetisi.judul_kompetisi AS 'judul', kompetisi.deadline - CURDATE() AS 'deadline', kompetisi.total_hadiah AS 'total', main_kat.main_kat AS 'main_kat', kompetisi.penyelenggara AS 'penyelenggara' 
		FROM kompetisi 
		LEFT JOIN thumb on kompetisi.id_kompetisi = thumb.id_kompetisi 
		LEFT JOIN main_kat ON main_kat.id_main_kat = kompetisi.id_main_kat 
		LEFT JOIN user ON kompetisi.author = user.id_user 
	...
	function show_kompetisi_diikuti($id, $limit, $offset) {
		$sql = "SELECT user.username AS 'authusername',  kompetisi.id_kompetisi AS 'id', main_kat.main_kat AS 'main_kat', kompetisi.judul_kompetisi AS 'judul', kompetisi.penyelenggara AS 'penyelenggara',kompetisi.sort AS 'sort',kompetisi.deadline - CURDATE() AS 'deadline', kompetisi.pengumuman - CURDATE() AS ' pengumuman', kompetisi.total_hadiah AS 'total' FROM kompetisi
